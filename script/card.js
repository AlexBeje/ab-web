...
const cardData = {
  firstCard: {
    ...
    button: "https://www.amazon.es/clouddrive/share/mt8wf4cfJUwSjWLHE8SAFjfWXbTyERnmi5BdHoZbVOJ",
  },
  secondCard: {
    title: "FREED0M",
    subtitle: "Video",
  ...
  thirdCard: {
    ...
    button: "https://www.figma.com/file/2emDRlJyx6XPLFfU7v499u/AB-Web?node-id=46%3A1",
  },
};
...
function selectSecondCard() {
  ...
  cardTitle1.innerHTML = cardData.secondCard.title;
  cardSubtitle1.innerHTML = cardData.secondCard.subtitle;
  cardText1.innerHTML = cardData.secondCard.text;
  cardImg1.style.backgroundImage = cardData.secondCard.img;
}
...
function selectThirdCard() {
  ...
  cardTitle1.innerHTML = cardData.thirdCard.title;
  cardSubtitle1.innerHTML = cardData.thirdCard.subtitle;
  cardText1.innerHTML = cardData.thirdCard.text;
  cardImg1.style.backgroundImage = cardData.thirdCard.img;
}
